            ...
            .then(data => {
                ...
                if (localRecipies != null) {
                    ...
                    setTimeout(()=>{
                        ...
                        document.querySelector("#recipe_list").classList.remove("hidden");
                    },3000)
                }
            })
    ...
    return (
        <>
            <div className='min-h-[200px] relative'>
                ...
                <div id="chef_details" className='flex border border-gray-400 rounded-xl p-4 bg-white hidden'>
